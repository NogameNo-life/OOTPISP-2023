    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(avgButton, &QPushButton::clicked, this, &MainWindow::countavg);
...
void MainWindow::countavg() {
    ...
    sum /= size * size;
    matrixavg->setText("avg: " + QString::number(sum));
}
